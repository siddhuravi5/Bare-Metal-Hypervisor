...
EXTERN Vmx_Vm_exit_Handler:PROC
EXTERN Vmx_VMResume:PROC
EXTERN BMHV_Return_Stack_Pointer_For_Vmxoff:PROC
EXTERN BMHV_Return_Instruction_Pointer_For_Vmxoff:PROC
...
AsmVmxoffHandler PROC
    ...
    call BMHV_Return_Stack_Pointer_For_Vmxoff
    add rsp, 020h       ; remove for shadow space

    mov [rsp+088h], rax  ; now, rax contains rsp

    sub rsp, 020h       ; shadow space
    call BMHV_Return_Instruction_Pointer_For_Vmxoff
    add rsp, 020h       ; remove for shadow space
