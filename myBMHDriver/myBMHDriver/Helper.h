...
#define LogInfo(format, ...)  \
    LogPrintInfo("Info : " format "\n",	\
		  __VA_ARGS__)

#define LogWarning(format, ...)  \
    LogPrintWarning("Warn : " format "\n",	\
		__VA_ARGS__)

#define LogError(format, ...)  \
    LogPrintError("Err : " format "\n",	\
		  __VA_ARGS__);	\
		DbgBreakPoint()
...
BOOLEAN Broadcast_To_ALL_Processors(ULONG ProcessorNumber, RunOnLogicalCoreFunc Routine);
...
// IRP Major Functions
NTSTATUS CreateDriver(PDEVICE_OBJECT DeviceObject, PIRP Irp);
NTSTATUS ReadDriver(PDEVICE_OBJECT DeviceObject, PIRP Irp);
NTSTATUS  WriteDriver(PDEVICE_OBJECT DeviceObject, PIRP Irp);
NTSTATUS CloseDriver(PDEVICE_OBJECT DeviceObject, PIRP Irp);
NTSTATUS UnsupportedDriver(PDEVICE_OBJECT DeviceObject, PIRP Irp);
